            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="relative h-64 md:h-96 overflow-hidden">
                  ...
                  <div
                    className={`h-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-8xl ${
                      post.image && post.image.startsWith("http")
                        ? "hidden"
                        : ""
                    }`}
                      ...
                      >
                        ...
                        >
                          <div className="relative h-40 overflow-hidden">
                            ...
                            <div
                              className={`h-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-4xl ${
                                relatedPost.image &&
                                relatedPost.image.startsWith("http")
                                  ? "hidden"
                                  : ""
                      ...
                      >
                        <div className="flex items-center mb-2 space-x-3 group cursor-pointer">
                          <div className="relative w-16 h-16 rounded-lg overflow-hidden">
                            {popularPost.image &&
                            popularPost.image.startsWith("http") ? (
                              <Image
                            ...
                            <div
                              className={`absolute inset-0 bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-2xl ${
                                popularPost.image &&
                                popularPost.image.startsWith("http")
                                  ? "hidden"
                                  : ""
