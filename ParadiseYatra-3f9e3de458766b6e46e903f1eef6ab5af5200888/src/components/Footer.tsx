  ...
  return (
    <footer className="bg-gray-900 text-white relative pt-16 pb-12 md:pt-24 md:pb-16">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <ul
              className={`space-y-2 md:space-y-3 ${
                expandedSections.international ? "block" : "hidden md:block"
              }`}
            >
          ...
          >
            ...
            <ul
              className={`space-y-2 md:space-y-3 ${
                expandedSections.india ? "block" : "hidden md:block"
              }`}
            >
          ...
          >
            ...
            <ul
              className={`space-y-2 md:space-y-3 ${
                expandedSections.quickLinks ? "block" : "hidden md:block"
              }`}
            >
      ...
      >
        <a
          href={`https://wa.me/${
            footerData?.companyInfo?.whatsapp?.replace(/\D/g, "") ||
            "918979269388"
          }`}
          target="_blank"
          rel="noopener noreferrer"
